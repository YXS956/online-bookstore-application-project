package bookStore.mybatis.myspringmvc;

import bookStore.mybatis.ioc.BeanFactory;
                ...
                if(operate.equals(method.getName())){
                    ...
                    for (int i = 0; i < parameters.length; i++) {
                        ...
                        if("request".equals(parameterName)){
                            ...
                            if("user/login".equals(parameterValue)) {
                                request.getSession().setAttribute("currUser",null);
                            }
                            if(parameterObj!=null && parameterObj!="") {
                                if ("java.lang.Integer".equals(typeName)) {
                                    parameterObj = Integer.parseInt(parameterValue);
                                }
                            }
                            if(parameterObj=="" && "java.lang.Integer".equals(typeName)){
                                parameterObj = null;
                            }
                    ...
                    if(methodReturnStr.startsWith("redirect:")){        //比如：  redirect:fruit.do
                        ...
                        //如果返回给vue函数的不需要value即jsonstr，那么函数返回值为“”
