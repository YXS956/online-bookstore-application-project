...
public class CartItem {
    ...
    public CartItem(Book book, Integer buyCount, User userBean, String state) {
        this.book = book;
        this.buyCount = buyCount;
        this.userBean = userBean;
        this.state = state;
    ...
    public CartItem(User userBean){this.userBean = userBean;}
    ...
    public Double getXj() {
        if(Objects.equals(state, "p")){
            ...
            BigDecimal bigDecimalPrice = new BigDecimal(""+getBook().getEprice());
            BigDecimal bigDecimalBuyCount = new BigDecimal(""+buyCount);
            BigDecimal bigDecimalXJ = bigDecimalPrice.multiply(bigDecimalBuyCount);
            xj = bigDecimalXJ.doubleValue() ;
        }
